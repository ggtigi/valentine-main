...
function App() {
    ...
    return (
        <div className="main">
            {isValentine ? (
                <>
                    <h2 className="title"> Владёна, Я тебя очень сильно люблю, иы с тобой много что прошли, но я не собираюсь всё заканчивать, 14 февраля - это наш с тобой и надеюсь что мы его проведём Отлично, безумно люблю тебя &hearts; </h2>
